...
class ModelBuilder:
    def __init__(self, model_number):
        ...
        self.c0w0 = np.loadtxt( ''.join([os.path.dirname(__file__), '/../model/', model_number, '/rnn/multi_rnn_cell/cell_0/basic_rnn_cell/kernel:0']), delimiter=',' )
        self.c0b0 = np.loadtxt( ''.join([os.path.dirname(__file__), '/../model/', model_number, '/rnn/multi_rnn_cell/cell_0/basic_rnn_cell/bias:0']), delimiter=',' )
        self.c1w0 = np.loadtxt( ''.join([os.path.dirname(__file__), '/../model/', model_number, '/rnn/multi_rnn_cell/cell_1/basic_rnn_cell/kernel:0']), delimiter=',' )
        self.c1b0 = np.loadtxt( ''.join([os.path.dirname(__file__), '/../model/', model_number, '/rnn/multi_rnn_cell/cell_1/basic_rnn_cell/bias:0']), delimiter=',' )
